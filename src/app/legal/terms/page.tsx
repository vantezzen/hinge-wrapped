...
function Terms() {
  return (
    <LegalPage>
      <Head>
        <title>Wrapped for Hinge - Terms of Service</title>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          ...
          for Hinge ("Service"), a web application that provides personalized
          statistics on your Hinge usage.
        </p>
        <p>
        ...
        <p>
          The Service relies on data from Hinge's API and other third-party
